...
if(process.platform!=='win32'||process.arch!=='x64'||electron!==supported.electron||sqlite!==supported.sqlite)throw new Error('This validated native build targets Electron 40.10.6 + SQLite module 12.11.1 on Windows x64. Revalidate the binary when upgrading.');
